...
public class Main {
    public static void main(String[] args) {
        ...
        Mécanico g = new Mécanico("Mandamucho");

        Vagones m = new Vagones("Hause");
        ...
        System.out.println(JefeDeEstación.Jefe + " caballeros");
        System.out.println(Mécanico.mécanico + " generales");
